...
def main(page: ft.Page):
    ...
    # Better desktop behavior on large screens
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                ft.Container(
                    ...
                    border=ft.Border(top=ft.BorderSide(1, "#EFEFEF")),
    ...
    # Fixed-size stage so it doesn't look split across huge screens
    main_layout = ft.Container(
        width=1700,
        height=980,
        bgcolor=BG,
        border=ft.Border.all(1, "#E6E8EB"),
        shadow=ft.BoxShadow(
            blur_radius=10,
            spread_radius=0,
            color="#12000000",
