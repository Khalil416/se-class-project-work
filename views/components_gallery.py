...
# Use explicit hex values for maximum compatibility across Flet versions.
COLORS = {
    "TEXT_MUTED": "#616161",
    "APPBAR_BG": "#F2F2F2",
    "BOTTOM_APPBAR_BG": "#EDEDED",
    "CONTAINER_BG": "#FFE0B2",
}
...
def components_gallery_view(page: ft.Page) -> ft.View:
            ...
            content=ft.Container(
                ...
                content=ft.Column(
                    ...
                    controls=[
                        ...
                        ft.ElevatedButton(
                            "Close",
                            on_click=lambda __: close_bottom_sheet(sheet),
                        ),
                    ],
                ),
            )
    ...
    def close_bottom_sheet(sheet: ft.BottomSheet):
        sheet.open = False
        page.update()
    ...
    demo_table = ft.DataTable(
        ...
        rows=[
            ft.DataRow(
                cells=[
                    ft.DataCell(ft.Text("Milk")),
                    ft.DataCell(ft.Text("Dairy")),
                    ft.DataCell(ft.Text("12")),
                ]
            ),
            ft.DataRow(
                cells=[
                    ft.DataCell(ft.Text("Tomatoes")),
                    ft.DataCell(ft.Text("Produce")),
                    ft.DataCell(ft.Text("35")),
                ]
            ),
            ft.DataRow(
                cells=[
                    ft.DataCell(ft.Text("Bread")),
                    ft.DataCell(ft.Text("Bakery")),
    ...
    button_examples = ft.Column(
        ...
        controls=[
            ...
            ft.Button("Button with Click Event", on_click=show_snackbar),
